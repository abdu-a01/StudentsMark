"""This package provides Different functions
and class used to manipulate students mark
...
from .calculate.one_stud.grading import grade_fun, point_fun, gpa_fun, gpa, average
